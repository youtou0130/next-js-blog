    ...
    return (
        <div className="container mx-auto mt-10">
          ...
          <form action={formAction} className="space-y-4">
              ...
              {preview && (
                <div className="border p-4 bg-gray-50 prose max-w-none prose-pre:bg-transparent prose-pre:p-0 prose-pre:text-inherit" >
                    <ReactMarkdown
              ...
              <Button type="submit" className="bg-blue-500 text-white px-4 py-2">投稿する</Button>
          </form>
        </div>
    )
}